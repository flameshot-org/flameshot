...
void GeneralConf::initLogToFile()
{
    ...
    m_logFileLevel->addItem(tr("Info"), AbstractLogger::Channel::Info);
    m_logFileLevel->addItem(tr("Warning"), AbstractLogger::Channel::Warning);
    m_logFileLevel->addItem(tr("Error"), AbstractLogger::Channel::Error);
